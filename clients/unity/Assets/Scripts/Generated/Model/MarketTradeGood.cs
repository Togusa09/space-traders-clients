...
namespace SpaceTraders.Generated.Model
{
    ...
    public partial class MarketTradeGood
    {
        ...
        public MarketTradeGood(TradeSymbol symbol = default, TypeEnum type = default, int tradeVolume = default, SupplyLevel supply = default, ActivityLevel? activity = default, int purchasePrice = default, int sellPrice = default)
        {
            this.Symbol = symbol;
            this.Type = type;
