...
namespace SpaceTraders.Generated.Model
{
    ...
    public partial class GetSystemWaypointsTraitsParameter : AbstractOpenAPISchema
    {
        /// <summary>
        ...
        public override Object ActualInstance
        {
            ...
            set
            {
                if (value.GetType() == typeof(List<WaypointTraitSymbol>) || value is List<WaypointTraitSymbol>)
                {
                    this._actualInstance = value;
                }
                else if (value.GetType() == typeof(WaypointTraitSymbol) || value is WaypointTraitSymbol)
                {
                    this._actualInstance = value;
                }
                else
        ...
        public static GetSystemWaypointsTraitsParameter FromJson(string jsonString)
        {
            ...
            catch (Exception exception)
            {
                ...
                // UnityEngine.Debug.Log(string.Format("Failed to deserialize `{0}` into ...", jsonString, exception.ToString()));
            }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                ...
                case JsonToken.StartArray:
                    return GetSystemWaypointsTraitsParameter.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
