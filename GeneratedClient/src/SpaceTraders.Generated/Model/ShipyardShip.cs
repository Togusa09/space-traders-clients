...
namespace SpaceTraders.Generated.Model
{
    ...
    public partial class ShipyardShip
    {
        ...
        public ShipyardShip(ShipType type = default, string name = default, string description = default, SupplyLevel supply = default, ActivityLevel? activity = default, int purchasePrice = default, ShipFrame frame = default, ShipReactor reactor = default, ShipEngine engine = default, List<ShipModule> modules = default, List<ShipMount> mounts = default, ShipyardShipCrew crew = default)
        {
            this.Type = type;
