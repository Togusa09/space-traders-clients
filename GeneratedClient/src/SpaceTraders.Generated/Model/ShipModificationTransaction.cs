...
namespace SpaceTraders.Generated.Model
{
    ...
    public partial class ShipModificationTransaction
    {
        ...
        public ShipModificationTransaction(string waypointSymbol = default, string shipSymbol = default, string tradeSymbol = default, int totalPrice = default, DateTimeOffset timestamp = default)
        {
