...
namespace SpaceTraders.Generated.Model
{
    ...
    public partial class SystemWaypoint
    {
        ...
        public SystemWaypoint(string symbol = default, WaypointType type = default, int x = default, int y = default, List<WaypointOrbital> orbitals = default, string orbits = default)
        {
